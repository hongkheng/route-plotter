...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routePlotter = __webpack_require__(169);

	var _routePlotter2 = _interopRequireDefault(_routePlotter);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_reactDom2.default.render(_react2.default.createElement(_routePlotter2.default, null), document.getElementById('route-plotter'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _possibleConstructorReturn2 = __webpack_require__(252);
	...
	var _mapRenderer = __webpack_require__(277);

	var _mapRenderer2 = _interopRequireDefault(_mapRenderer);

	var _coordinatesList = __webpack_require__(278);

	var _coordinatesList2 = _interopRequireDefault(_coordinatesList);

	var _retrievePlot = __webpack_require__(279);

	var _retrievePlot2 = _interopRequireDefault(_retrievePlot);
	...
	*/
	...
	var RoutePlotter = function (_React$Component) {
	  (0, _inherits3.default)(RoutePlotter, _React$Component);

	  function RoutePlotter(props) {
	    (0, _classCallCheck3.default)(this, RoutePlotter);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(RoutePlotter).call(this, props));
	    ...
	    _this.updateCoordinates = _this.updateCoordinates.bind(_this);
	    return _this;
	  }

	  (0, _createClass3.default)(RoutePlotter, [{
	    key: 'setMap',
	    ...
	    value: function updateCoordinates(input) {
	      var _this2 = this;

	      var inputData = JSON.parse(input);
	      var directionsService = new google.maps.DirectionsService();
	      var inputLatLng = inputData.map(function (coordinates) {
	        return new (Function.prototype.bind.apply(google.maps.LatLng, [null].concat((0, _toConsumableArray3.default)(coordinates))))();
	      });
	      this.setState({ query: inputData });

	      this.updateQueue = _promise2.default.resolve();

	      var updateDirections = function updateDirections(renderer, origin, destination, waypoints) {
	      ...
	      var _loop = function _loop(i) {
	        ...
	        var lastOrigin = inputLatLng[i];
	        var lastDestination = inputLatLng[i + 1];
	        ...
	        renderer.directions_changed = function () {
	          ...
	          if (i > 0 && currentOrigin !== lastOrigin) {
	            ...
	            var _directions = _this2.directionsRenderers[i - 1].getDirections();
	            var _directions$request2 = _directions.request;
	            var origin = _directions$request2.origin;
	            var waypoints = _directions$request2.waypoints;

	            updateDirections(_this2.directionsRenderers[i - 1], origin, currentOrigin, waypoints);
	          } else if (i < inputLatLng.length - 1 && currentDestination !== lastDestination) {
	            lastDestination = currentDestination;
	            var _directions2 = _this2.directionsRenderers[i + 1].getDirections();
	            var _directions2$request = _directions2.request;
	            var destination = _directions2$request.destination;
	        ...
	        _this2.directionsRenderers.push(renderer);
	        _this2.state.result.push([lastOrigin, lastDestination]);
	      };

	      for (var i = 0; i < inputLatLng.length - 1; i++) {
	        _loop(i);
	      }
	    }
	  }, {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_mapRenderer2.default, {
	          onMount: this.setMap }),
	        _react2.default.createElement(_coordinatesList2.default, {
	          onUpdate: this.updateCoordinates }),
	        this.state.result && _react2.default.createElement(_retrievePlot2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(184)(IteratorPrototype, __webpack_require__(214)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global        = __webpack_require__(180)
	  , hide          = __webpack_require__(184)
	  , Iterators     = __webpack_require__(196)
	  , TO_STRING_TAG = __webpack_require__(214)('toStringTag');
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(182)(Function.call, __webpack_require__(229).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CoordinatesList = function (_React$Component) {
	  (0, _inherits3.default)(CoordinatesList, _React$Component);

	  function CoordinatesList() {
	    (0, _classCallCheck3.default)(this, CoordinatesList);
	    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(CoordinatesList).apply(this, arguments));
	  }

	  (0, _createClass3.default)(CoordinatesList, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'h1',
	          { style: styleProps.title },
	          'Experimental Route Plotter'
	        ),
	        _react2.default.createElement('div', { id: 'map', style: styleProps.map })
	      );
	    }
	  }]);
	...
	exports.default = CoordinatesList;
	        ...
	        _react2.default.createElement(
	          ...
	          { className: 'btn btn-primary',
	            ...
	            onClick: function onClick(e) {
	              return _this2.props.onUpdate(_this2.refs.input.value);
	            } },
	          'Submit'
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RetrievePlot = function (_React$Component) {
	  (0, _inherits3.default)(RetrievePlot, _React$Component);

	  function RetrievePlot() {
	    (0, _classCallCheck3.default)(this, RetrievePlot);
	    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(RetrievePlot).apply(this, arguments));
	  }

	  (0, _createClass3.default)(RetrievePlot, [{
	    key: 'render',
	    value: function render() {
	      var points = this.props.result.reduce(function (allPoints, somePoints) {
	        return allPoints.concat(somePoints);
	      }, []);
	      var polyline = google.maps.geometry.encoding.encodePath(points);
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'container', style: styleProps.container },
	        _react2.default.createElement(
	          'h2',
	          null,
	          'Retrieve Plot'
	...
	RetrievePlot.propTypes = {
	  result: _react.PropTypes.arrayOf(_react.PropTypes.arrayOf(_react.PropTypes.object))
	};
	exports.default = RetrievePlot;
