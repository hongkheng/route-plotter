...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mapRenderer = __webpack_require__(266);

	var _mapRenderer2 = _interopRequireDefault(_mapRenderer);

	var _coordinatesList = __webpack_require__(267);

	var _coordinatesList2 = _interopRequireDefault(_coordinatesList);

	var _retrievePlot = __webpack_require__(268);
	...
	*/
	...
	var RoutePlotter = function (_React$Component) {
	  ...
	  (0, _createClass3.default)(RoutePlotter, [{
	    key: 'setRenderer',
	    value: function setRenderer(map) {
	      var _this2 = this;

	      var renderer = new google.maps.DirectionsRenderer({ map: map, draggable: true });
	      renderer.directions_changed = function () {
	        ...
	        var origin = _directions$request.origin;
	        var destination = _directions$request.destination;
	        var waypoints = _directions$request.waypoints;

	        waypoints = [origin].concat((0, _toConsumableArray3.default)(waypoints.map(function (point) {
	          return point.location;
	        })), [destination]);
	        _this2.setState({
	          waypoints: waypoints.map(function (point) {
	            return [point.lat(), point.lng()];
	          }),
	          points: overview_path.map(function (point) {
	            return [point.lat(), point.lng()];
	          }),
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        this.state.waypoints && _react2.default.createElement(_retrievePlot2.default, this.state)
	      );
	    }
	  }]);
	  return RoutePlotter;
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(182)(Function.call, __webpack_require__(254).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  (0, _createClass3.default)(RetrievePlot, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        this.props.waypoints.map(function (latLng, i) {
	          return _react2.default.createElement(
	            'p',
	            { key: i },
	            latLng[0].toFixed(16),
	        ...
	        this.props.points.map(function (latLng, i) {
	          return _react2.default.createElement(
	            'p',
	            { key: i },
	            latLng[0].toFixed(16),
	...
	RetrievePlot.propTypes = {
	  waypoints: _react.PropTypes.array,
